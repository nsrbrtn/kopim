...
- [**Форма перевода**](transaction_transfer_form.md) — порядок счетов назначения и правила фильтрации в сценарии transfer
...
- [**Мини-онбординг первого запуска**](mini_onboarding.md) — компактный чеклист на `Home`, порядок стартовых действий и правила автопоказа
...
- [**Стартовые auth entry-flow**](auth_entry_flows.md) — матрица экранов входа для `webProdCloudOnly`, `firebaseDev`, `storeProdLocalFirst` и offline-контура
