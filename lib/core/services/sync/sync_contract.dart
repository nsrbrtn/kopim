...
enum SyncReferencePolicy {
  keepReferenceAfterParentTombstone,
  childMustBeInactiveBeforeParentTombstone,
  independentTombstone,
}

class SyncReferenceDescriptor {
  const SyncReferenceDescriptor({
...
class SyncEntityManifestEntry {
  ...
  final SyncReferencePolicy referencePolicy;
  final List<SyncReferenceDescriptor> references;
}
...
class SyncContract {
  ...
  static const List<SyncEntityManifestEntry>
  manifest = <SyncEntityManifestEntry>[
    SyncEntityManifestEntry(
      ...
      referencePolicy: SyncReferencePolicy.keepReferenceAfterParentTombstone,
      references: <SyncReferenceDescriptor>[],
    ),
    SyncEntityManifestEntry(
      key: 'categories',
    ...
    SyncEntityManifestEntry(
      ...
      referencePolicy: SyncReferencePolicy.independentTombstone,
      references: <SyncReferenceDescriptor>[],
    ),
    SyncEntityManifestEntry(
      ...
      references: <SyncReferenceDescriptor>[
        ...
        SyncReferenceDescriptor(fieldName: 'tagId', parentEntityType: 'tag'),
      ],
    ),
    SyncEntityManifestEntry(
      key: 'transactions',
      ...
      references: <SyncReferenceDescriptor>[
        ...
        SyncReferenceDescriptor(
          ...
          parentEntityType: 'saving_goal',
          nullable: true,
        ),
        SyncReferenceDescriptor(
          fieldName: 'groupId',
          parentEntityType: 'credit_payment_group',
          nullable: true,
        ),
      ],
    ),
    ...
    SyncEntityManifestEntry(
      ...
      referencePolicy:
          SyncReferencePolicy.childMustBeInactiveBeforeParentTombstone,
      references: <SyncReferenceDescriptor>[
        SyncReferenceDescriptor(
          fieldName: 'accountId',
          parentEntityType: 'account',
    ...
    SyncEntityManifestEntry(
      ...
      references: <SyncReferenceDescriptor>[
        ...
        SyncReferenceDescriptor(
          ...
          parentEntityType: 'credit_payment_schedule',
          nullable: true,
        ),
      ],
    ),
