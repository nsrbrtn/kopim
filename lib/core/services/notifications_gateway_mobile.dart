...
NotificationsGateway createNotificationsGateway({
  ...
  return MobileNotificationsGateway(
    plugin: plugin,
    logger: logger,
    exactAlarmPermissionService: exactAlarmPermissionService,
  );
...
class MobileNotificationsGateway implements NotificationsGateway {
  MobileNotificationsGateway({
    FlutterLocalNotificationsPlugin? plugin,
    LoggerService? logger,
    ExactAlarmPermissionService? exactAlarmPermissionService,
  ...
  Future<void> _ensureInitialized() async {
    ...
    if (androidImplementation != null) {
      const AndroidNotificationChannel channel = AndroidNotificationChannel(
        NotificationsGateway.channelId,
        NotificationsGateway.channelName,
        description: NotificationsGateway.channelDescription,
  ...
  NotificationDetails _buildNotificationDetails({
    ...
    return NotificationDetails(
      android: AndroidNotificationDetails(
        NotificationsGateway.channelId,
        NotificationsGateway.channelName,
        channelDescription: NotificationsGateway.channelDescription,
        importance: Importance.high,
