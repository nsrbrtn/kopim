...
@ProviderFor(categoryGroupDao)
const categoryGroupDaoProvider = CategoryGroupDaoProvider._();

final class CategoryGroupDaoProvider
    extends
        $FunctionalProvider<
          CategoryGroupDao,
          CategoryGroupDao,
          CategoryGroupDao
        >
    with $Provider<CategoryGroupDao> {
  const CategoryGroupDaoProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'categoryGroupDaoProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$categoryGroupDaoHash();

  @$internal
  @override
  $ProviderElement<CategoryGroupDao> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  CategoryGroupDao create(Ref ref) {
    return categoryGroupDao(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CategoryGroupDao value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CategoryGroupDao>(value),
    );
  }
}

String _$categoryGroupDaoHash() => r'13e0f4863582845faf08f51b942679dd95f253fc';

@ProviderFor(categoryGroupLinkDao)
const categoryGroupLinkDaoProvider = CategoryGroupLinkDaoProvider._();

final class CategoryGroupLinkDaoProvider
    extends
        $FunctionalProvider<
          CategoryGroupLinkDao,
          CategoryGroupLinkDao,
          CategoryGroupLinkDao
        >
    with $Provider<CategoryGroupLinkDao> {
  const CategoryGroupLinkDaoProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'categoryGroupLinkDaoProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$categoryGroupLinkDaoHash();

  @$internal
  @override
  $ProviderElement<CategoryGroupLinkDao> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  CategoryGroupLinkDao create(Ref ref) {
    return categoryGroupLinkDao(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CategoryGroupLinkDao value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CategoryGroupLinkDao>(value),
    );
  }
}

String _$categoryGroupLinkDaoHash() =>
    r'175b3ae51110a424908d59bbb5dfcc5e42203276';
...
final class ExportDataRepositoryProvider
  ...
  const ExportDataRepositoryProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'exportDataRepositoryProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$exportDataRepositoryHash();

  @$internal
  @override
  $ProviderElement<ExportDataRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  ExportDataRepository create(Ref ref) {
    return exportDataRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ExportDataRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ExportDataRepository>(value),
    );
  }
}

String _$exportDataRepositoryHash() =>
    r'cc43f36988efd994d071d1bbac7d92443d114090';
...
final class ExportBundleJsonEncoderProvider
  ...
  const ExportBundleJsonEncoderProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'exportBundleJsonEncoderProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$exportBundleJsonEncoderHash();

  @$internal
  @override
  $ProviderElement<ExportBundleJsonEncoder> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  ExportBundleJsonEncoder create(Ref ref) {
    return exportBundleJsonEncoder(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ExportBundleJsonEncoder value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ExportBundleJsonEncoder>(value),
    );
  }
}
...
final class ExportFileSaverProvider
  ...
  const ExportFileSaverProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'exportFileSaverProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$exportFileSaverHash();

  @$internal
  @override
  $ProviderElement<ExportFileSaver> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  ExportFileSaver create(Ref ref) {
    return exportFileSaver(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ExportFileSaver value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ExportFileSaver>(value),
    );
  }
}
...
final class PrepareExportBundleUseCaseProvider
  ...
  const PrepareExportBundleUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'prepareExportBundleUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$prepareExportBundleUseCaseHash();

  @$internal
  @override
  $ProviderElement<PrepareExportBundleUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  PrepareExportBundleUseCase create(Ref ref) {
    return prepareExportBundleUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(PrepareExportBundleUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<PrepareExportBundleUseCase>(value),
    );
  }
}

String _$prepareExportBundleUseCaseHash() =>
...
final class ExportUserDataUseCaseProvider
  ...
  const ExportUserDataUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'exportUserDataUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$exportUserDataUseCaseHash();

  @$internal
  @override
  $ProviderElement<ExportUserDataUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  ExportUserDataUseCase create(Ref ref) {
    return exportUserDataUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ExportUserDataUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ExportUserDataUseCase>(value),
    );
  }
}
...
final class CreditDaoProvider
  ...
  @override
  String debugGetCreateSourceHash() => _$creditDaoHash();

  @$internal
  @override
  $ProviderElement<CreditDao> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  CreditDao create(Ref ref) {
    return creditDao(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CreditDao value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CreditDao>(value),
    );
  }
}
...
final class CreditCardDaoProvider
  ...
  @override
  String debugGetCreateSourceHash() => _$creditCardDaoHash();

  @$internal
  @override
  $ProviderElement<CreditCardDao> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  CreditCardDao create(Ref ref) {
    return creditCardDao(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CreditCardDao value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CreditCardDao>(value),
    );
  }
}
...
@ProviderFor(categoryGroupRemoteDataSource)
const categoryGroupRemoteDataSourceProvider =
    CategoryGroupRemoteDataSourceProvider._();

final class CategoryGroupRemoteDataSourceProvider
    extends
        $FunctionalProvider<
          ...
          CategoryGroupRemoteDataSource
        >
    with $Provider<CategoryGroupRemoteDataSource> {
  const CategoryGroupRemoteDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'categoryGroupRemoteDataSourceProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$categoryGroupRemoteDataSourceHash();

  @$internal
  @override
  $ProviderElement<CategoryGroupRemoteDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  CategoryGroupRemoteDataSource create(Ref ref) {
    return categoryGroupRemoteDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CategoryGroupRemoteDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CategoryGroupRemoteDataSource>(
        value,
      ),
    );
  }
...
String _$categoryGroupRemoteDataSourceHash() =>
    r'e6a3e9019e31b8c53691262a6a99d1b6ebf4c6fb';

@ProviderFor(categoryGroupLinkRemoteDataSource)
const categoryGroupLinkRemoteDataSourceProvider =
    CategoryGroupLinkRemoteDataSourceProvider._();

final class CategoryGroupLinkRemoteDataSourceProvider
    extends
        $FunctionalProvider<
          ...
          CategoryGroupLinkRemoteDataSource
        >
    with $Provider<CategoryGroupLinkRemoteDataSource> {
  const CategoryGroupLinkRemoteDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'categoryGroupLinkRemoteDataSourceProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  String debugGetCreateSourceHash() =>
      _$categoryGroupLinkRemoteDataSourceHash();

  @$internal
  @override
  $ProviderElement<CategoryGroupLinkRemoteDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  CategoryGroupLinkRemoteDataSource create(Ref ref) {
    return categoryGroupLinkRemoteDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CategoryGroupLinkRemoteDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CategoryGroupLinkRemoteDataSource>(
        value,
      ),
    );
  }
...
String _$categoryGroupLinkRemoteDataSourceHash() =>
    r'7122f146774b1581877bb4c2052abea2b950f1ba';
...
final class AddCreditUseCaseProvider
  ...
  const AddCreditUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'addCreditUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$addCreditUseCaseHash();

  @$internal
  @override
  $ProviderElement<AddCreditUseCase> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  AddCreditUseCase create(Ref ref) {
    return addCreditUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(AddCreditUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<AddCreditUseCase>(value),
    );
  }
}
...
final class UpdateCreditCardUseCaseProvider
  ...
  const UpdateCreditCardUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'updateCreditCardUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$updateCreditCardUseCaseHash();

  @$internal
  @override
  $ProviderElement<UpdateCreditCardUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  UpdateCreditCardUseCase create(Ref ref) {
    return updateCreditCardUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(UpdateCreditCardUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<UpdateCreditCardUseCase>(value),
    );
  }
}

String _$updateCreditCardUseCaseHash() =>
...
final class DeleteCreditCardUseCaseProvider
  ...
  const DeleteCreditCardUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'deleteCreditCardUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$deleteCreditCardUseCaseHash();

  @$internal
  @override
  $ProviderElement<DeleteCreditCardUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  DeleteCreditCardUseCase create(Ref ref) {
    return deleteCreditCardUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(DeleteCreditCardUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<DeleteCreditCardUseCase>(value),
    );
  }
}

String _$deleteCreditCardUseCaseHash() =>
...
final class GetCreditCardByAccountIdUseCaseProvider
  ...
  const GetCreditCardByAccountIdUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'getCreditCardByAccountIdUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$getCreditCardByAccountIdUseCaseHash();

  @$internal
  @override
  $ProviderElement<GetCreditCardByAccountIdUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  GetCreditCardByAccountIdUseCase create(Ref ref) {
    return getCreditCardByAccountIdUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(GetCreditCardByAccountIdUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<GetCreditCardByAccountIdUseCase>(
        value,
      ),
    );
  }
...
String _$getCreditCardByAccountIdUseCaseHash() =>
...
final class DeleteCreditUseCaseProvider
  ...
  const DeleteCreditUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'deleteCreditUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$deleteCreditUseCaseHash();

  @$internal
  @override
  $ProviderElement<DeleteCreditUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  DeleteCreditUseCase create(Ref ref) {
    return deleteCreditUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(DeleteCreditUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<DeleteCreditUseCase>(value),
    );
  }
}
...
final class WatchCreditsUseCaseProvider
  ...
  const WatchCreditsUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'watchCreditsUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$watchCreditsUseCaseHash();

  @$internal
  @override
  $ProviderElement<WatchCreditsUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  WatchCreditsUseCase create(Ref ref) {
    return watchCreditsUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(WatchCreditsUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<WatchCreditsUseCase>(value),
    );
  }
}

String _$watchCreditsUseCaseHash() =>
...
final class WatchCreditCardsUseCaseProvider
  ...
  const WatchCreditCardsUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'watchCreditCardsUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$watchCreditCardsUseCaseHash();

  @$internal
  @override
  $ProviderElement<WatchCreditCardsUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  WatchCreditCardsUseCase create(Ref ref) {
    return watchCreditCardsUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(WatchCreditCardsUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<WatchCreditCardsUseCase>(value),
    );
  }
}

String _$watchCreditCardsUseCaseHash() =>
...
@ProviderFor(categoryGroupRepository)
const categoryGroupRepositoryProvider = CategoryGroupRepositoryProvider._();

final class CategoryGroupRepositoryProvider
    extends
        $FunctionalProvider<
          ...
          CategoryGroupRepository
        >
    with $Provider<CategoryGroupRepository> {
  const CategoryGroupRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'categoryGroupRepositoryProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$categoryGroupRepositoryHash();

  @$internal
  @override
  $ProviderElement<CategoryGroupRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  CategoryGroupRepository create(Ref ref) {
    return categoryGroupRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CategoryGroupRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CategoryGroupRepository>(value),
    );
  }
}

String _$categoryGroupRepositoryHash() =>
    r'ea127e4fcceeadb16a4719a5730db06eaec70a27';
...
@ProviderFor(saveCategoryGroupUseCase)
const saveCategoryGroupUseCaseProvider = SaveCategoryGroupUseCaseProvider._();

final class SaveCategoryGroupUseCaseProvider
    extends
        $FunctionalProvider<
          SaveCategoryGroupUseCase,
          SaveCategoryGroupUseCase,
          SaveCategoryGroupUseCase
        >
    with $Provider<SaveCategoryGroupUseCase> {
  const SaveCategoryGroupUseCaseProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'saveCategoryGroupUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$saveCategoryGroupUseCaseHash();

  @$internal
  @override
  $ProviderElement<SaveCategoryGroupUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  SaveCategoryGroupUseCase create(Ref ref) {
    return saveCategoryGroupUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(SaveCategoryGroupUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<SaveCategoryGroupUseCase>(value),
    );
  }
}

String _$saveCategoryGroupUseCaseHash() =>
    r'd528c67edb1f69a289905c6b0a344ad150e3aacd';
...
@ProviderFor(deleteCategoryGroupUseCase)
const deleteCategoryGroupUseCaseProvider =
    DeleteCategoryGroupUseCaseProvider._();

final class DeleteCategoryGroupUseCaseProvider
    extends
        $FunctionalProvider<
          ...
          DeleteCategoryGroupUseCase
        >
    with $Provider<DeleteCategoryGroupUseCase> {
  const DeleteCategoryGroupUseCaseProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'deleteCategoryGroupUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$deleteCategoryGroupUseCaseHash();

  @$internal
  @override
  $ProviderElement<DeleteCategoryGroupUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  DeleteCategoryGroupUseCase create(Ref ref) {
    return deleteCategoryGroupUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(DeleteCategoryGroupUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<DeleteCategoryGroupUseCase>(value),
    );
  }
}

String _$deleteCategoryGroupUseCaseHash() =>
    r'51f2478e7dce08f0d99abbadfd2d2bddc6335eae';
...
@ProviderFor(setCategoryGroupCategoriesUseCase)
const setCategoryGroupCategoriesUseCaseProvider =
    SetCategoryGroupCategoriesUseCaseProvider._();

final class SetCategoryGroupCategoriesUseCaseProvider
    extends
        $FunctionalProvider<
          ...
          SetCategoryGroupCategoriesUseCase
        >
    with $Provider<SetCategoryGroupCategoriesUseCase> {
  const SetCategoryGroupCategoriesUseCaseProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'setCategoryGroupCategoriesUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() =>
      _$setCategoryGroupCategoriesUseCaseHash();

  @$internal
  @override
  $ProviderElement<SetCategoryGroupCategoriesUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  SetCategoryGroupCategoriesUseCase create(Ref ref) {
    return setCategoryGroupCategoriesUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(SetCategoryGroupCategoriesUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<SetCategoryGroupCategoriesUseCase>(
        value,
      ),
    );
  }
...
String _$setCategoryGroupCategoriesUseCaseHash() =>
    r'740329169d416a02636ef35873abe8ae7514ba24';

@ProviderFor(updateCategoryGroupOrderUseCase)
const updateCategoryGroupOrderUseCaseProvider =
    UpdateCategoryGroupOrderUseCaseProvider._();

final class UpdateCategoryGroupOrderUseCaseProvider
    extends
        $FunctionalProvider<
          UpdateCategoryGroupOrderUseCase,
          UpdateCategoryGroupOrderUseCase,
          UpdateCategoryGroupOrderUseCase
        >
    with $Provider<UpdateCategoryGroupOrderUseCase> {
  const UpdateCategoryGroupOrderUseCaseProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'updateCategoryGroupOrderUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$updateCategoryGroupOrderUseCaseHash();

  @$internal
  @override
  $ProviderElement<UpdateCategoryGroupOrderUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  UpdateCategoryGroupOrderUseCase create(Ref ref) {
    return updateCategoryGroupOrderUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(UpdateCategoryGroupOrderUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<UpdateCategoryGroupOrderUseCase>(
        value,
      ),
    );
  }
...
String _$updateCategoryGroupOrderUseCaseHash() =>
    r'999ccd7f7cb65d9f5dbbfeab5761a048a0c1ea7a';
...
final class WatchAccountMonthlyTotalsUseCaseProvider
  ...
  const WatchAccountMonthlyTotalsUseCaseProvider._()
    : super(
        ...
        argument: null,
        retry: null,
        name: r'watchAccountMonthlyTotalsUseCaseProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$watchAccountMonthlyTotalsUseCaseHash();

  @$internal
  @override
  $ProviderElement<WatchAccountMonthlyTotalsUseCase> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  WatchAccountMonthlyTotalsUseCase create(Ref ref) {
    return watchAccountMonthlyTotalsUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(WatchAccountMonthlyTotalsUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<WatchAccountMonthlyTotalsUseCase>(
        value,
      ),
    );
  }
...
String _$authSyncServiceHash() => r'5e98c9ced4f83db864a1d6f32070aa7f876573c1';
