...
class CategoryGroupRow extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, sortOrder, createdAt, updatedAt, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $CategoryGroupLinksTable extends CategoryGroupLinks
    with TableInfo<$CategoryGroupLinksTable, CategoryGroupLinkRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CategoryGroupLinksTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'category_group_links';
  @override
  VerificationContext validateIntegrity(
    Insertable<CategoryGroupLinkRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  CategoryGroupLinkRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CategoryGroupLinkRow(
  ...
  @override
  $CategoryGroupLinksTable createAlias(String alias) {
    return $CategoryGroupLinksTable(attachedDatabase, alias);
  }
}

class CategoryGroupLinkRow extends DataClass
    implements Insertable<CategoryGroupLinkRow> {
  final String groupId;
  final String categoryId;
  final DateTime createdAt;
  final DateTime updatedAt;
  final bool isDeleted;
  const CategoryGroupLinkRow({
  ...
  CategoryGroupLinksCompanion toCompanion(bool nullToAbsent) {
    return CategoryGroupLinksCompanion(
  ...
  factory CategoryGroupLinkRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CategoryGroupLinkRow copyWithCompanion(CategoryGroupLinksCompanion data) {
    return CategoryGroupLinkRow(
  ...
  @override
  String toString() {
    return (StringBuffer('CategoryGroupLinkRow(')
  ...
  @override
  int get hashCode =>
      Object.hash(groupId, categoryId, createdAt, updatedAt, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CategoryGroupLinkRow &&
...
class CategoryGroupLinksCompanion
    extends UpdateCompanion<CategoryGroupLinkRow> {
  ...
  final Value<bool> isDeleted;
  final Value<int> rowid;
  const CategoryGroupLinksCompanion({
  ...
  CategoryGroupLinksCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       categoryId = Value(categoryId);
  static Insertable<CategoryGroupLinkRow> custom({
  ...
  CategoryGroupLinksCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('CategoryGroupLinksCompanion(')
          ..write('groupId: $groupId, ')
          ..write('categoryId: $categoryId, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CategoryGroupLinksTable categoryGroupLinks =
      $CategoryGroupLinksTable(this);
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<
    $CategoryGroupLinksTable,
    List<CategoryGroupLinkRow>
  >
  _categoryGroupLinksRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.categoryGroupLinks,
        aliasName: $_aliasNameGenerator(
          db.categories.id,
          db.categoryGroupLinks.categoryId,
        ),
      );

  $$CategoryGroupLinksTableProcessedTableManager get categoryGroupLinksRefs {
    final manager = $$CategoryGroupLinksTableTableManager(
      $_db,
      $_db.categoryGroupLinks,
    ).filter((f) => f.categoryId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _categoryGroupLinksRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$CategoriesTableFilterComposer
  ...
  Expression<bool> categoryGroupLinksRefs(
    Expression<bool> Function($$CategoryGroupLinksTableFilterComposer f) f,
  ) {
    final $$CategoryGroupLinksTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.categoryGroupLinks,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$CategoryGroupLinksTableFilterComposer(
            $db: $db,
            $table: $db.categoryGroupLinks,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$CategoriesTableAnnotationComposer
  ...
  Expression<T> categoryGroupLinksRefs<T extends Object>(
    Expression<T> Function($$CategoryGroupLinksTableAnnotationComposer a) f,
  ) {
    final $$CategoryGroupLinksTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.categoryGroupLinks,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$CategoryGroupLinksTableAnnotationComposer(
                $db: $db,
                $table: $db.categoryGroupLinks,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
          ...
          prefetchHooksCallback:
              ({
                ...
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (categoryGroupLinksRefs) db.categoryGroupLinks,
                      ...
                      if (categoryGroupLinksRefs)
                        ...
                        >(
                          ...
                          referencedTable: $$CategoriesTableReferences
                              ._categoryGroupLinksRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$CategoriesTableReferences(
                                db,
                                table,
                                p0,
                              ).categoryGroupLinksRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
...
class $$CategoryGroupsTableTableManager
    extends
        RootTableManager<
          ...
          (CategoryGroupRow, $$CategoryGroupsTableReferences),
          CategoryGroupRow,
          PrefetchHooks Function({bool categoryGroupLinksRefs})
        > {
    ...
    $CategoryGroupsTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({categoryGroupLinksRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (categoryGroupLinksRefs) db.categoryGroupLinks,
...
typedef $$CategoryGroupsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool categoryGroupLinksRefs})
    >;
typedef $$CategoryGroupLinksTableCreateCompanionBuilder =
    CategoryGroupLinksCompanion Function({
      required String groupId,
      required String categoryId,
      Value<DateTime> createdAt,
      Value<DateTime> updatedAt,
...
typedef $$CategoryGroupLinksTableUpdateCompanionBuilder =
    CategoryGroupLinksCompanion Function({
      Value<String> groupId,
      Value<String> categoryId,
      Value<DateTime> createdAt,
...
final class $$CategoryGroupLinksTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $CategoryGroupLinksTable,
          CategoryGroupLinkRow
        > {
  $$CategoryGroupLinksTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
...
class $$CategoryGroupLinksTableFilterComposer
    extends Composer<_$AppDatabase, $CategoryGroupLinksTable> {
  $$CategoryGroupLinksTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$CategoryGroupLinksTableOrderingComposer
    extends Composer<_$AppDatabase, $CategoryGroupLinksTable> {
  $$CategoryGroupLinksTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CategoryGroupLinksTableAnnotationComposer
    extends Composer<_$AppDatabase, $CategoryGroupLinksTable> {
  $$CategoryGroupLinksTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$CategoryGroupLinksTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CategoryGroupLinksTable,
          ...
          $$CategoryGroupLinksTableOrderingComposer,
          $$CategoryGroupLinksTableAnnotationComposer,
          $$CategoryGroupLinksTableCreateCompanionBuilder,
          $$CategoryGroupLinksTableUpdateCompanionBuilder,
          (CategoryGroupLinkRow, $$CategoryGroupLinksTableReferences),
          CategoryGroupLinkRow,
          PrefetchHooks Function({bool groupId, bool categoryId})
        > {
  $$CategoryGroupLinksTableTableManager(
    _$AppDatabase db,
    $CategoryGroupLinksTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CategoryGroupLinksTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CategoryGroupLinksTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CategoryGroupLinksTableAnnotationComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CategoryGroupLinksTableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$CategoryGroupLinksTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CategoryGroupLinksTable,
      CategoryGroupLinkRow,
...
class $AppDatabaseManager {
  ...
  $$CategoryGroupLinksTableTableManager get categoryGroupLinks =>
      $$CategoryGroupLinksTableTableManager(_db, _db.categoryGroupLinks);
