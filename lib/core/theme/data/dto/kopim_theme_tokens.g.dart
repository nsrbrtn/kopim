...
_KopimThemeTokenBundle _$KopimThemeTokenBundleFromJson(
  Map<String, dynamic> json,
) => _KopimThemeTokenBundle(
  lightColors: KopimSystemColorTokens.fromJson(
    json['lightColors'] as Map<String, dynamic>,
  ),
  darkColors: KopimSystemColorTokens.fromJson(
    json['darkColors'] as Map<String, dynamic>,
  ),
  typography: KopimTypographyTokens.fromJson(
    json['typography'] as Map<String, dynamic>,
  ),
  shape: KopimShapeTokens.fromJson(json['shape'] as Map<String, dynamic>),
...
Map<String, dynamic> _$KopimThemeTokenBundleToJson(
  _KopimThemeTokenBundle instance,
) => <String, dynamic>{
  'lightColors': instance.lightColors,
...
Map<String, dynamic> _$KopimSystemColorTokensToJson(
  _KopimSystemColorTokens instance,
) => <String, dynamic>{
...
_KopimTypographyTokens _$KopimTypographyTokensFromJson(
  Map<String, dynamic> json,
) => _KopimTypographyTokens(
  displayLarge: KopimTextStyleTokens.fromJson(
    json['displayLarge'] as Map<String, dynamic>,
  ),
  displayMedium: KopimTextStyleTokens.fromJson(
    json['displayMedium'] as Map<String, dynamic>,
  ),
  displaySmall: KopimTextStyleTokens.fromJson(
    json['displaySmall'] as Map<String, dynamic>,
  ),
  headlineLarge: KopimTextStyleTokens.fromJson(
    json['headlineLarge'] as Map<String, dynamic>,
  ),
  headlineMedium: KopimTextStyleTokens.fromJson(
    json['headlineMedium'] as Map<String, dynamic>,
  ),
  headlineSmall: KopimTextStyleTokens.fromJson(
    json['headlineSmall'] as Map<String, dynamic>,
  ),
  titleLarge: KopimTextStyleTokens.fromJson(
    json['titleLarge'] as Map<String, dynamic>,
  ),
  titleMedium: KopimTextStyleTokens.fromJson(
    json['titleMedium'] as Map<String, dynamic>,
  ),
  titleSmall: KopimTextStyleTokens.fromJson(
    json['titleSmall'] as Map<String, dynamic>,
  ),
  bodyLarge: KopimTextStyleTokens.fromJson(
    json['bodyLarge'] as Map<String, dynamic>,
  ),
  bodyMedium: KopimTextStyleTokens.fromJson(
    json['bodyMedium'] as Map<String, dynamic>,
  ),
  bodySmall: KopimTextStyleTokens.fromJson(
    json['bodySmall'] as Map<String, dynamic>,
  ),
  labelLarge: KopimTextStyleTokens.fromJson(
    json['labelLarge'] as Map<String, dynamic>,
  ),
  labelMedium: KopimTextStyleTokens.fromJson(
    json['labelMedium'] as Map<String, dynamic>,
  ),
  labelSmall: KopimTextStyleTokens.fromJson(
    json['labelSmall'] as Map<String, dynamic>,
  ),
);

Map<String, dynamic> _$KopimTypographyTokensToJson(
  _KopimTypographyTokens instance,
) => <String, dynamic>{
...
_KopimTextStyleTokens _$KopimTextStyleTokensFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$KopimTextStyleTokensToJson(
  _KopimTextStyleTokens instance,
) => <String, dynamic>{
...
_KopimShapeTokens _$KopimShapeTokensFromJson(Map<String, dynamic> json) =>
    _KopimShapeTokens(
      radius: (json['radius'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(k, (e as num).toDouble()),
      ),
      borderWidth: (json['borderWidth'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(k, (e as num).toDouble()),
      ),
    );

Map<String, dynamic> _$KopimShapeTokensToJson(_KopimShapeTokens instance) =>
    <String, dynamic>{
      'radius': instance.radius,
      'borderWidth': instance.borderWidth,
    };

_KopimSpacingTokens _$KopimSpacingTokensFromJson(Map<String, dynamic> json) =>
    _KopimSpacingTokens(
...
Map<String, dynamic> _$KopimSpacingTokensToJson(_KopimSpacingTokens instance) =>
    <String, dynamic>{'values': instance.values};

_KopimSizeTokens _$KopimSizeTokensFromJson(Map<String, dynamic> json) =>
    _KopimSizeTokens(
      touch: (json['touch'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(k, (e as num).toDouble()),
      ),
...
Map<String, dynamic> _$KopimSizeTokensToJson(_KopimSizeTokens instance) =>
    <String, dynamic>{
...
_KopimMotionTokens _$KopimMotionTokensFromJson(Map<String, dynamic> json) =>
    _KopimMotionTokens(
      durations: KopimMotionDurations.fromJson(
        json['durations'] as Map<String, dynamic>,
      ),
      easing: KopimMotionEasing.fromJson(
        json['easing'] as Map<String, dynamic>,
      ),
    );

Map<String, dynamic> _$KopimMotionTokensToJson(_KopimMotionTokens instance) =>
    <String, dynamic>{
      'durations': instance.durations,
      'easing': instance.easing,
    };

_KopimMotionDurations _$KopimMotionDurationsFromJson(
  Map<String, dynamic> json,
) => _KopimMotionDurations(
  xxs: const DurationMsConverter().fromJson((json['xxs'] as num).toInt()),
  xs: const DurationMsConverter().fromJson((json['xs'] as num).toInt()),
  sm: const DurationMsConverter().fromJson((json['sm'] as num).toInt()),
  md: const DurationMsConverter().fromJson((json['md'] as num).toInt()),
  lg: const DurationMsConverter().fromJson((json['lg'] as num).toInt()),
  xl: const DurationMsConverter().fromJson((json['xl'] as num).toInt()),
  xxl: const DurationMsConverter().fromJson((json['xxl'] as num).toInt()),
);

Map<String, dynamic> _$KopimMotionDurationsToJson(
  _KopimMotionDurations instance,
) => <String, dynamic>{
  'xxs': const DurationMsConverter().toJson(instance.xxs),
  'xs': const DurationMsConverter().toJson(instance.xs),
  'sm': const DurationMsConverter().toJson(instance.sm),
  'md': const DurationMsConverter().toJson(instance.md),
  'lg': const DurationMsConverter().toJson(instance.lg),
  'xl': const DurationMsConverter().toJson(instance.xl),
  'xxl': const DurationMsConverter().toJson(instance.xxl),
};

_KopimMotionEasing _$KopimMotionEasingFromJson(Map<String, dynamic> json) =>
    _KopimMotionEasing(
      standard: const CubicConverter().fromJson(
        json['standard'] as List<double>,
      ),
      decelerate: const CubicConverter().fromJson(
        json['decelerate'] as List<double>,
      ),
      accelerate: const CubicConverter().fromJson(
        json['accelerate'] as List<double>,
      ),
      emphasized: const CubicConverter().fromJson(
        json['emphasized'] as List<double>,
      ),
    );

Map<String, dynamic> _$KopimMotionEasingToJson(_KopimMotionEasing instance) =>
    <String, dynamic>{
      'standard': const CubicConverter().toJson(instance.standard),
      'decelerate': const CubicConverter().toJson(instance.decelerate),
