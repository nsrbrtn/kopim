...
abstract class ContributeState with _$ContributeState {
  const factory ContributeState({
    ...
    @Default(<AccountEntity>[]) List<AccountEntity> goalStorageAccounts,
    String? selectedAccountId,
    String? selectedStorageAccountId,
    String? goalAccountCurrency,
    @Default('') String amountInput,
    String? amountError,
    String? sourceAccountError,
    String? storageAccountError,
    String? note,
