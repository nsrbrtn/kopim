...
mixin _$ContributeState {
 ...
 SavingGoal get goal; List<AccountEntity> get accounts; String? get selectedAccountId; String? get goalAccountCurrency; String get amountInput; String? get amountError; String? get sourceAccountError; String? get note; bool get isSubmitting; bool get success; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,goal,const DeepCollectionEquality().hash(accounts),selectedAccountId,goalAccountCurrency,amountInput,amountError,sourceAccountError,note,isSubmitting,success,errorMessage);

@override
String toString() {
  return 'ContributeState(goal: $goal, accounts: $accounts, selectedAccountId: $selectedAccountId, goalAccountCurrency: $goalAccountCurrency, amountInput: $amountInput, amountError: $amountError, sourceAccountError: $sourceAccountError, note: $note, isSubmitting: $isSubmitting, success: $success, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 SavingGoal goal, List<AccountEntity> accounts, String? selectedAccountId, String? goalAccountCurrency, String amountInput, String? amountError, String? sourceAccountError, String? note, bool isSubmitting, bool success, String? errorMessage
});
...
/// Create a copy of ContributeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? goal = null,Object? accounts = null,Object? selectedAccountId = freezed,Object? goalAccountCurrency = freezed,Object? amountInput = null,Object? amountError = freezed,Object? sourceAccountError = freezed,Object? note = freezed,Object? isSubmitting = null,Object? success = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SavingGoal goal,  List<AccountEntity> accounts,  String? selectedAccountId,  String? goalAccountCurrency,  String amountInput,  String? amountError,  String? sourceAccountError,  String? note,  bool isSubmitting,  bool success,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContributeState() when $default != null:
return $default(_that.goal,_that.accounts,_that.selectedAccountId,_that.goalAccountCurrency,_that.amountInput,_that.amountError,_that.sourceAccountError,_that.note,_that.isSubmitting,_that.success,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SavingGoal goal,  List<AccountEntity> accounts,  String? selectedAccountId,  String? goalAccountCurrency,  String amountInput,  String? amountError,  String? sourceAccountError,  String? note,  bool isSubmitting,  bool success,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _ContributeState():
return $default(_that.goal,_that.accounts,_that.selectedAccountId,_that.goalAccountCurrency,_that.amountInput,_that.amountError,_that.sourceAccountError,_that.note,_that.isSubmitting,_that.success,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SavingGoal goal,  List<AccountEntity> accounts,  String? selectedAccountId,  String? goalAccountCurrency,  String amountInput,  String? amountError,  String? sourceAccountError,  String? note,  bool isSubmitting,  bool success,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _ContributeState() when $default != null:
return $default(_that.goal,_that.accounts,_that.selectedAccountId,_that.goalAccountCurrency,_that.amountInput,_that.amountError,_that.sourceAccountError,_that.note,_that.isSubmitting,_that.success,_that.errorMessage);case _:
  return null;
...
class _ContributeState implements ContributeState {
  const _ContributeState({required this.goal, final  List<AccountEntity> accounts = const <AccountEntity>[], this.selectedAccountId, this.goalAccountCurrency, this.amountInput = '', this.amountError, this.sourceAccountError, this.note, this.isSubmitting = false, this.success = false, this.errorMessage}): _accounts = accounts;
...
@override
int get hashCode => Object.hash(runtimeType,goal,const DeepCollectionEquality().hash(_accounts),selectedAccountId,goalAccountCurrency,amountInput,amountError,sourceAccountError,note,isSubmitting,success,errorMessage);
...
/// Create a copy of ContributeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? goal = null,Object? accounts = null,Object? selectedAccountId = freezed,Object? goalAccountCurrency = freezed,Object? amountInput = null,Object? amountError = freezed,Object? sourceAccountError = freezed,Object? note = freezed,Object? isSubmitting = null,Object? success = null,Object? errorMessage = freezed,}) {
