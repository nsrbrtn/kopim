...
const List<PhosphorIconDescriptor> kAccountIconOptions =
    <PhosphorIconDescriptor>[
      ...
      PhosphorIconDescriptor(name: 'airplane', style: PhosphorIconStyle.fill),
      PhosphorIconDescriptor(name: 'briefcase', style: PhosphorIconStyle.fill),
    ];
