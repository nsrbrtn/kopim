...
mixin _$AccountEntity {
 ...
 String get id; String get name;@JsonKey(includeFromJson: false, includeToJson: false) BigInt? get balanceMinor;@JsonKey(includeFromJson: false, includeToJson: false) BigInt? get openingBalanceMinor; String get currency;@JsonKey(includeFromJson: false, includeToJson: false) int? get currencyScale; String get type; int get typeVersion; DateTime get createdAt; DateTime get updatedAt; String? get color; String? get gradientId; String? get iconName; String? get iconStyle; bool get isDeleted; bool get isPrimary; bool get isHidden;
...
@useResult
$Res call({
 String id, String name,@JsonKey(includeFromJson: false, includeToJson: false) BigInt? balanceMinor,@JsonKey(includeFromJson: false, includeToJson: false) BigInt? openingBalanceMinor, String currency,@JsonKey(includeFromJson: false, includeToJson: false) int? currencyScale, String type, int typeVersion, DateTime createdAt, DateTime updatedAt, String? color, String? gradientId, String? iconName, String? iconStyle, bool isDeleted, bool isPrimary, bool isHidden
});
...
/// Create a copy of AccountEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? balanceMinor = freezed,Object? openingBalanceMinor = freezed,Object? currency = null,Object? currencyScale = freezed,Object? type = null,Object? typeVersion = null,Object? createdAt = null,Object? updatedAt = null,Object? color = freezed,Object? gradientId = freezed,Object? iconName = freezed,Object? iconStyle = freezed,Object? isDeleted = null,Object? isPrimary = null,Object? isHidden = null,}) {
...
as String,typeVersion: null == typeVersion ? _self.typeVersion : typeVersion // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(includeFromJson: false, includeToJson: false)  BigInt? balanceMinor, @JsonKey(includeFromJson: false, includeToJson: false)  BigInt? openingBalanceMinor,  String currency, @JsonKey(includeFromJson: false, includeToJson: false)  int? currencyScale,  String type,  int typeVersion,  DateTime createdAt,  DateTime updatedAt,  String? color,  String? gradientId,  String? iconName,  String? iconStyle,  bool isDeleted,  bool isPrimary,  bool isHidden)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountEntity() when $default != null:
return $default(_that.id,_that.name,_that.balanceMinor,_that.openingBalanceMinor,_that.currency,_that.currencyScale,_that.type,_that.typeVersion,_that.createdAt,_that.updatedAt,_that.color,_that.gradientId,_that.iconName,_that.iconStyle,_that.isDeleted,_that.isPrimary,_that.isHidden);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(includeFromJson: false, includeToJson: false)  BigInt? balanceMinor, @JsonKey(includeFromJson: false, includeToJson: false)  BigInt? openingBalanceMinor,  String currency, @JsonKey(includeFromJson: false, includeToJson: false)  int? currencyScale,  String type,  int typeVersion,  DateTime createdAt,  DateTime updatedAt,  String? color,  String? gradientId,  String? iconName,  String? iconStyle,  bool isDeleted,  bool isPrimary,  bool isHidden)  $default,) {final _that = this;
switch (_that) {
case _AccountEntity():
return $default(_that.id,_that.name,_that.balanceMinor,_that.openingBalanceMinor,_that.currency,_that.currencyScale,_that.type,_that.typeVersion,_that.createdAt,_that.updatedAt,_that.color,_that.gradientId,_that.iconName,_that.iconStyle,_that.isDeleted,_that.isPrimary,_that.isHidden);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name, @JsonKey(includeFromJson: false, includeToJson: false)  BigInt? balanceMinor, @JsonKey(includeFromJson: false, includeToJson: false)  BigInt? openingBalanceMinor,  String currency, @JsonKey(includeFromJson: false, includeToJson: false)  int? currencyScale,  String type,  int typeVersion,  DateTime createdAt,  DateTime updatedAt,  String? color,  String? gradientId,  String? iconName,  String? iconStyle,  bool isDeleted,  bool isPrimary,  bool isHidden)?  $default,) {final _that = this;
switch (_that) {
case _AccountEntity() when $default != null:
return $default(_that.id,_that.name,_that.balanceMinor,_that.openingBalanceMinor,_that.currency,_that.currencyScale,_that.type,_that.typeVersion,_that.createdAt,_that.updatedAt,_that.color,_that.gradientId,_that.iconName,_that.iconStyle,_that.isDeleted,_that.isPrimary,_that.isHidden);case _:
  return null;
...
class _AccountEntity extends AccountEntity {
  const _AccountEntity({required this.id, required this.name, @JsonKey(includeFromJson: false, includeToJson: false) this.balanceMinor, @JsonKey(includeFromJson: false, includeToJson: false) this.openingBalanceMinor, required this.currency, @JsonKey(includeFromJson: false, includeToJson: false) this.currencyScale, required this.type, this.typeVersion = 0, required this.createdAt, required this.updatedAt, this.color, this.gradientId, this.iconName, this.iconStyle, this.isDeleted = false, this.isPrimary = false, this.isHidden = false}): super._();
...
@override@JsonKey() final  int typeVersion;
...
/// Create a copy of AccountEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? balanceMinor = freezed,Object? openingBalanceMinor = freezed,Object? currency = null,Object? currencyScale = freezed,Object? type = null,Object? typeVersion = null,Object? createdAt = null,Object? updatedAt = null,Object? color = freezed,Object? gradientId = freezed,Object? iconName = freezed,Object? iconStyle = freezed,Object? isDeleted = null,Object? isPrimary = null,Object? isHidden = null,}) {
