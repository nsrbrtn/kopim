...
mixin _$BudgetFormState implements DiagnosticableTreeMixin {
 ...
 String get title; String get amountText; BudgetPeriod get period; BudgetScope get scope; DateTime get startDate; DateTime? get endDate; List<String> get categoryIds; List<String> get accountIds; Map<String, String> get categoryAmounts; Budget? get initialBudget; bool get isSubmitting; String? get errorMessage; BudgetCategoryLimitConflict? get categoryLimitConflict;
...
@useResult
$Res call({
 String title, String amountText, BudgetPeriod period, BudgetScope scope, DateTime startDate, DateTime? endDate, List<String> categoryIds, List<String> accountIds, Map<String, String> categoryAmounts, Budget? initialBudget, bool isSubmitting, String? errorMessage, BudgetCategoryLimitConflict? categoryLimitConflict
});
...
/// Create a copy of BudgetFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? amountText = null,Object? period = null,Object? scope = null,Object? startDate = null,Object? endDate = freezed,Object? categoryIds = null,Object? accountIds = null,Object? categoryAmounts = null,Object? initialBudget = freezed,Object? isSubmitting = null,Object? errorMessage = freezed,Object? categoryLimitConflict = freezed,}) {
...
as String?,categoryLimitConflict: freezed == categoryLimitConflict ? _self.categoryLimitConflict : categoryLimitConflict // ignore: cast_nullable_to_non_nullable
as BudgetCategoryLimitConflict?,
  ));
}
/// Create a copy of BudgetFormState
/// with the given fields replaced by the non-null parameter values.
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String amountText,  BudgetPeriod period,  BudgetScope scope,  DateTime startDate,  DateTime? endDate,  List<String> categoryIds,  List<String> accountIds,  Map<String, String> categoryAmounts,  Budget? initialBudget,  bool isSubmitting,  String? errorMessage,  BudgetCategoryLimitConflict? categoryLimitConflict)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BudgetFormState() when $default != null:
return $default(_that.title,_that.amountText,_that.period,_that.scope,_that.startDate,_that.endDate,_that.categoryIds,_that.accountIds,_that.categoryAmounts,_that.initialBudget,_that.isSubmitting,_that.errorMessage,_that.categoryLimitConflict);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String amountText,  BudgetPeriod period,  BudgetScope scope,  DateTime startDate,  DateTime? endDate,  List<String> categoryIds,  List<String> accountIds,  Map<String, String> categoryAmounts,  Budget? initialBudget,  bool isSubmitting,  String? errorMessage,  BudgetCategoryLimitConflict? categoryLimitConflict)  $default,) {final _that = this;
switch (_that) {
case _BudgetFormState():
return $default(_that.title,_that.amountText,_that.period,_that.scope,_that.startDate,_that.endDate,_that.categoryIds,_that.accountIds,_that.categoryAmounts,_that.initialBudget,_that.isSubmitting,_that.errorMessage,_that.categoryLimitConflict);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String amountText,  BudgetPeriod period,  BudgetScope scope,  DateTime startDate,  DateTime? endDate,  List<String> categoryIds,  List<String> accountIds,  Map<String, String> categoryAmounts,  Budget? initialBudget,  bool isSubmitting,  String? errorMessage,  BudgetCategoryLimitConflict? categoryLimitConflict)?  $default,) {final _that = this;
switch (_that) {
case _BudgetFormState() when $default != null:
return $default(_that.title,_that.amountText,_that.period,_that.scope,_that.startDate,_that.endDate,_that.categoryIds,_that.accountIds,_that.categoryAmounts,_that.initialBudget,_that.isSubmitting,_that.errorMessage,_that.categoryLimitConflict);case _:
  return null;
...
class _BudgetFormState with DiagnosticableTreeMixin implements BudgetFormState {
  const _BudgetFormState({required this.title, required this.amountText, required this.period, required this.scope, required this.startDate, this.endDate, final  List<String> categoryIds = const <String>[], final  List<String> accountIds = const <String>[], final  Map<String, String> categoryAmounts = const <String, String>{}, this.initialBudget, this.isSubmitting = false, this.errorMessage, this.categoryLimitConflict}): _categoryIds = categoryIds,_accountIds = accountIds,_categoryAmounts = categoryAmounts;
...
@override final  BudgetCategoryLimitConflict? categoryLimitConflict;
...
@override
int get hashCode => Object.hash(runtimeType,title,amountText,period,scope,startDate,endDate,const DeepCollectionEquality().hash(_categoryIds),const DeepCollectionEquality().hash(_accountIds),const DeepCollectionEquality().hash(_categoryAmounts),initialBudget,isSubmitting,errorMessage,categoryLimitConflict);
...
/// Create a copy of BudgetFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? amountText = null,Object? period = null,Object? scope = null,Object? startDate = null,Object? endDate = freezed,Object? categoryIds = null,Object? accountIds = null,Object? categoryAmounts = null,Object? initialBudget = freezed,Object? isSubmitting = null,Object? errorMessage = freezed,Object? categoryLimitConflict = freezed,}) {
