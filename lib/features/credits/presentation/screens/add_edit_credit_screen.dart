  ...
  Future<void> _selectIcon() async {
    final PhosphorIconDescriptor? selection = await showPhosphorIconPicker(
      ...
      labels: PhosphorIconPickerLabels(
        ...
        emptyStateLabel: context.loc.manageCategoriesIconEmpty,
        styleLabels: <PhosphorIconStyle, String>{
          PhosphorIconStyle.thin: context.loc.manageCategoriesIconStyleThin,
          PhosphorIconStyle.light: context.loc.manageCategoriesIconStyleLight,
          PhosphorIconStyle.regular:
              context.loc.manageCategoriesIconStyleRegular,
          PhosphorIconStyle.bold: context.loc.manageCategoriesIconStyleBold,
          PhosphorIconStyle.fill: context.loc.manageCategoriesIconStyleFill,
        },
        groupLabels: <String, String>{
          'groceries': context.loc.manageCategoriesIconGroupGroceries,
          'dining': context.loc.manageCategoriesIconGroupDining,
          'clothing': context.loc.manageCategoriesIconGroupClothing,
          'home': context.loc.manageCategoriesIconGroupHome,
          'utilities': context.loc.manageCategoriesIconGroupUtilities,
          'communication': context.loc.manageCategoriesIconGroupCommunication,
          'subscriptions': context.loc.manageCategoriesIconGroupSubscriptions,
          'publicTransport':
              context.loc.manageCategoriesIconGroupPublicTransport,
          'car': context.loc.manageCategoriesIconGroupCar,
          'taxi': context.loc.manageCategoriesIconGroupTaxi,
          'travel': context.loc.manageCategoriesIconGroupTravel,
          'health': context.loc.manageCategoriesIconGroupHealth,
          'security': context.loc.manageCategoriesIconGroupSecurity,
          'education': context.loc.manageCategoriesIconGroupEducation,
          'family': context.loc.manageCategoriesIconGroupFamily,
          'pets': context.loc.manageCategoriesIconGroupPets,
          'maintenance': context.loc.manageCategoriesIconGroupMaintenance,
          'entertainment': context.loc.manageCategoriesIconGroupEntertainment,
          'sports': context.loc.manageCategoriesIconGroupSports,
          'finance': context.loc.manageCategoriesIconGroupFinance,
          'loans': context.loc.manageCategoriesIconGroupLoans,
          'documents': context.loc.manageCategoriesIconGroupDocuments,
          'settings': context.loc.manageCategoriesIconGroupSettings,
          'transactionTypes':
              context.loc.manageCategoriesIconGroupTransactionTypes,
        },
      ),
      initial: _icon,
