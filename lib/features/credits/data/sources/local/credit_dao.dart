...
class CreditDao {
  ...
  db.CreditsCompanion _mapToCompanion(CreditEntity credit) {
    ...
    return db.CreditsCompanion(
      ...
      interestCategoryId: Value<String?>(credit.interestCategoryId),
      feesCategoryId: Value<String?>(credit.feesCategoryId),
      firstPaymentDate: Value<DateTime?>(credit.firstPaymentDate),
