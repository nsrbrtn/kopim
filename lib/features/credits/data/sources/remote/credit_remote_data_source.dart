...
class CreditRemoteDataSource {
  ...
  Map<String, dynamic> toFirestorePayload(CreditEntity credit) =>
      _mapCredit(credit);
  ...
  Map<String, dynamic> _mapCredit(CreditEntity credit) {
    ...
    return <String, dynamic>{
      ...
      'firstPaymentDate': credit.firstPaymentDate == null
          ? null
          : Timestamp.fromDate(credit.firstPaymentDate!.toUtc()),
  ...
  CreditEntity fromDocument(QueryDocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return CreditEntity(
      ...
      interestCategoryId: data['interestCategoryId'] as String?,
      feesCategoryId: data['feesCategoryId'] as String?,
      ...
      firstPaymentDate: data['firstPaymentDate'] == null
          ? null
          : _parseTimestamp(data['firstPaymentDate']),
