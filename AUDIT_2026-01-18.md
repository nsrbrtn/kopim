...
- 2026-01-18: начата миграция модели денег: добавлены `Money` + `scale`, новые поля `amountMinor/balanceMinor` в доменных сущностях и документ `docs/logic/money_model.md`.
